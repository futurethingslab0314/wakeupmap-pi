...
// ✨ 新增：簡化的故事顯示邏輯 - 直接從Firebase抓取指定用戶的最新故事
async function displayLatestStoryFromFirebase() {
    try {
        console.log('📖 [簡化邏輯] 直接從Firebase獲取 ' + rawUserDisplayName + ' 用戶的最新故事...');
        ...
        if (!querySnapshot.empty) {
            ...
            console.log('⚠️ 沒有找到 ' + rawUserDisplayName + ' 用戶的記錄');
        }
