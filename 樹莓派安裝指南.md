...
### **Raspberry Pi 接線與設定**
### 按鈕x1：[+] 接到 GPIO 18 (實體針腳 12) 和 [-] 則接到 GND。
### DSI螢幕x1
### 喇叭x1
...
# 例如:  git clone -b yutingpi02 --single-branch https://github.com/futurethingslab0314/wakeupmap-pi.git
